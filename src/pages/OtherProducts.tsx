...
const OtherProducts = React.memo(() => {
  ...
  const { 
    ...
    loadMore, 
    refresh 
  } = useOptimizedProductsWithCache('Other Products');
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden font-inter">
      ...
      <StaticPageHeader title="Other Products" emoji="🏠" showUserIcon={false} />
      <StaticSearchBar 
      ...
      <div className="container mx-auto px-6 pb-20 relative z-10">
        ...
        {searchTerm && filteredProducts.length === 0 && products.length > 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No other products found matching your search.</p>
          </div>
        )}
      </div>
    </div>
...
OtherProducts.displayName = 'OtherProducts';
