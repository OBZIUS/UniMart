...
const Munchies = React.memo(() => {
  ...
  const { 
    ...
    loadMore, 
    refresh 
  } = useOptimizedProductsWithCache('Munchies');
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden font-inter">
      ...
      <StaticPageHeader title="Munchies" emoji="🍿" showUserIcon={false} />
      <StaticSearchBar 
      ...
      <div className="container mx-auto px-6 pb-20 relative z-10">
        ...
        {searchTerm && filteredProducts.length === 0 && products.length > 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No munchies found matching your search.</p>
          </div>
        )}
      </div>
    </div>
